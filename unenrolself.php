...
/**
 * Payment enrolment plugin - support for user self unenrolment.
 *
 * @package    enrol_payment
 * @copyright  2010 Petr Skoda  {@link http://skodak.org} (originally for enrol_paypal)
...
$instance = $DB->get_record('enrol', array('id' => $enrolid, 'enrol' => 'paypal'));
